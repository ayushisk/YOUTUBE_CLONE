      ...
      <div class="main-section">
        <div class="main-left">
          ...
          <button class="yt-side-button">
            ...
            <span class="side-channel-label white">Selena Art</span>
          </button>

          <button class="yt-side-button">
            <img src={ndtv} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">David Bombal</span>
          </button>

          <button class="yt-side-button">
            <img src={modi} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">BJP INDIA</span>
          </button>

          <button class="yt-side-button">
            <img src={tseries} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Music World</span>
          </button>

          <button class="yt-side-button">
            <img src={coke} height={"30px"} width={"30px"}></img>
            <span class="side-channel-label white">Shiv Shakti</span>
          </button>
        </div>
        ...
        <div class="main-right">
          <div className="navbar-container">
            <div class="navbar">
              ...
              <div class="navbar-items white">New to you</div>
              <div class="navbar-items white">Bollywood Music</div>
              <div class="navbar-items white">Computer Programming</div>
              <div class="navbar-items white">C Programming</div>
              <div class="navbar-items white">Corona Virus</div>
              <div class="navbar-items white">Life</div>
              <div class="navbar-items white">Zindagi</div>
              <div class="navbar-items white">Indian Series</div>
              <div class="navbar-items white">Funny Video</div>
              <div class="navbar-items white">Painting</div>
              <div class="navbar-items white">Pop Music</div>
              <div class="navbar-items white">Posts</div>
            </div>
          </div>
